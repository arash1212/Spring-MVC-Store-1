...
<html>
<head>
    <title>خطا در ورود به سایت</title>
</head>
...
<div class="container p-3 my-3 bg-dark text-white" style="max-width: 80%;text-align: right">
    ...
    <main role="main" class="container">
        <br/><br/>
        <h2>ایمیل و یا کلمه عبور اشتباه وارد شده است</h2>
        <br/><br/>
        <p class="lead">ایمیل و یا کلمه عبور وارد شده اشتباه است و یا اینکه این اطلاعات قبلا ثبت نشده است.</p>
